...
export default function RejectedPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 text-center">
      ...
      <h1 className="text-2xl font-bold text-foreground mb-3">عذراً، تم رفض طلبك</h1>
      ...
      <div className="bg-card border border-destructive/20 rounded-xl p-4 w-full max-w-sm mb-8 shadow-sm">
        ...
        <p className="text-sm text-foreground">
          {me?.agent?.rejectedReason || "لم يتم توضيح السبب. يرجى التأكد من صحة بياناتك المرفقة."}
        </p>
      </div>
