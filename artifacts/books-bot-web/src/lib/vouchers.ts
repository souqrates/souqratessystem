...
export const VOUCHER_CATEGORY_META: { id: VoucherCategory; nameAr: string; emoji: string; color: string }[] = [
  { id: 'gaming',        nameAr: 'الألعاب',            emoji: '🎮', color: '#22d3ee' },
  { id: 'apple',         nameAr: 'Apple',              emoji: '🍎', color: '#94a3b8' },
  { id: 'google',        nameAr: 'Google',             emoji: '🌐', color: '#34a853' },
  { id: 'entertainment', nameAr: 'الترفيه والموسيقى',  emoji: '🎬', color: '#ec4899' },
  { id: 'social',        nameAr: 'الشبكات الاجتماعية', emoji: '📱', color: '#f59e0b' },
  { id: 'other',         nameAr: 'بطاقات أخرى',        emoji: '💳', color: '#a855f7' },
];
