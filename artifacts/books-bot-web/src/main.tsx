...
// After a deploy, Vite emits new hashed filenames. A page opened before the
// deploy still points at OLD filenames; the browser gets the SPA index.html
// fallback and refuses it with "Unexpected token '<'". We catch that and
// hard-reload once (sessionStorage guard prevents infinite loops).
