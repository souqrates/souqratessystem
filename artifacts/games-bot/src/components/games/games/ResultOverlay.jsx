...
export default function ResultOverlay({
  ...
  return (
    <div style={{
      ...
      >
        <RotateCcw size={14} />
        {settling ? 'جاري التسوية…' : 'Play Again'}
      </motion.button>
    </div>
  );
}
